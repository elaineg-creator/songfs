...
class TestScript(unittest.TestCase):
    ...
    def test_get_dictionary(self):
        ...
        self.assertEqual(song_path_dict["always with me always with you.mp3"], os.path.normpath(os.getcwd() + "/../mp3_directory/parsemp3_test_songs/always-with-me-always-with-you-long-21256.mp3"))
        self.assertEqual(song_path_dict["Taylor Swift - Is It Over Now_ (Taylor's Version) (From The Vault) (Lyric Video) (64 kbps).mp3"], os.path.normpath(os.getcwd() + "/../mp3_directory/parsemp3_test_songs/Taylor Swift - Is It Over Now_ (Taylor's Version) (From The Vault) (Lyric Video) (64 kbps).mp3"))
